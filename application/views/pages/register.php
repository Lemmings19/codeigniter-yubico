        ...
        <div class="col-sm-8 col-md-6 col-lg-4">
            ...
            <?php echo form_open('users/register', ['id' => 'registerForm']); ?>
                <fieldset id="registerFormFieldset">
                    ...
                    <div id="tfaModal" class="modal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">
                                ...
                                <div class="modal-body">
                                    ...
                                    <ol>
                                        <li>
                                            Open or install Google Authenticator on your phone.
                                        </li>
                                        <li>
                                            Add the following key/information:
                                            <ul>
                                                <li>
                                                    Name: <strong>tfa example app</strong>
                                                </li>
                                                <li>
                                                    Key: <strong id="tfaSecret"></strong>
                                                </li>
                                                <li>
                                                    Time-based
                                                </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="form-group">
                                                <label for="tfa_code" class="control-label">
                                                    
                                                </label>

                                                <input type="tfa_code" maxlength="255" data-max-length="255" class="form-control" name="tfa_code" value="" placeholder="The generated code" minlength="1" />
                                            </div>
                                        </li>
                                    </ol>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-link" data-dismiss="modal">Back</button>
                                    <button id="tfaSubmit" type="button" class="btn btn-primary">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    $("#registerForm").submit(function (e) {
        ...
        if ($("[name=use_physical_key]").is(":checked")) {
            ...
            */
        ...
        } else if ($("[name=use_tfa]").is(":checked")) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(result) {
                    $("#tfaSecret").text(result.secret);
                    $("#authTypes,#authTypesLoading").toggle();
                    $("#tfaModal").modal("show");
                    // Load the code and button to proceed
                },
                error: function(xhr, status, error) {
                    $("#authTypes,#authTypesLoading").toggle();
                    $(".js-error").html("Couldn't generate code: " + error + ": " + xhr.responseText).show();
                }
            });
        }
    });

    $("#tfaSubmit").click(function() {
        $.ajax({
            url: "/apitfa/register",
            method: "GET",
            data: {
